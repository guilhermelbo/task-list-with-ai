...
name: java-pro
description: >
  Use this skill for modern Java 21+ development, Spring Boot, virtual threads,
  GraalVM native images, JVM optimization, and enterprise architecture patterns.
  Trigger for any Java task, Spring Boot questions, JPA/Hibernate, Spring Security,
  microservices with Spring Cloud, performance tuning, concurrency with virtual threads,
  Testcontainers, GraalVM, or enterprise Java architecture. Also trigger when the user
  is working with Maven/Gradle builds, Jakarta EE, or needs guidance on Java best practices.
---

# Java Pro

> When this skill is active, use this knowledge as specialized reference for modern Java 21+ development, Spring Boot, virtual threads, GraalVM, and enterprise architecture patterns.

---

## Use this skill when

- Working on Java tasks or workflows
- Needing guidance, best practices, or checklists for modern Java development
- Implementing Spring Boot applications, microservices, or cloud-native systems

## Do not use this skill when

- The task is unrelated to Java
